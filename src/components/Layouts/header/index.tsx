...
export function Header() {
  ...
  return (
    <header className="border-stroke shadow-1 dark:border-slate-800/80 dark:bg-[#070A0F]/95 backdrop-blur-md sticky top-0 z-30 flex items-center justify-between border-b bg-white px-4 py-5 md:px-5 2xl:px-10">
      <button
        onClick={toggleSidebar}
        className="dark:border-slate-800/80 rounded-lg border px-1.5 py-1 lg:hidden dark:bg-slate-800/80 hover:dark:bg-slate-700/80"
      >
        <MenuIcon />
